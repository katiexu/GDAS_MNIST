...
def search_func(
    ...
    for step, (base_inputs, base_targets, arch_inputs, arch_targets) in enumerate(
        ...
        base_targets = base_targets.cpu()
        arch_targets = arch_targets.cpu()
...
def main(xargs):
    ...
    search_loader, _, valid_loader = get_nas_search_loaders(
        ...
        valid_data,
        xargs.dataset,
        "C:/Users/xuke0/Desktop/AutoDL-Projects_TQ/configs/nas-benchmark",
        config.batch_size,
        xargs.workers,
    )
    ...
    search_space = ['RzRyRz', 'I', 'CNOT']      # for MNIST-2 dataset
    ...
    # design = translator(args.n_qubits, args.n_layers)
    search_model = QNet(args).to(args.device)
    ...
    #network, criterion = torch.nn.DataParallel(search_model).cpu(), criterion.cpu()
    network, criterion = search_model.cpu(), criterion.cpu()
    ...
    for epoch in range(args.n_epochs):
        ...
        if valid_a_top1 > valid_accuracies["best"]:
            ...
            genotypes["best"] = search_model.arch_parameters
            find_best = True
        else:
            find_best = False

        genotypes[epoch] = search_model.arch_parameters
        logger.log(
...
if __name__ == "__main__":
    ...
    # set GDAS arguments
    args.search_space_name = 'nas-bench-201'
    args.track_running_stats = 1
    args.config_path = r'C:\Users\xuke0\Desktop\AutoDL-Projects_TQ\configs\nas-benchmark\algos\GDAS.config'
    args.arch_learning_rate = 0.0003
    args.arch_weight_decay = 0.001
    args.tau_min = 0.1
    args.tau_max = 10
