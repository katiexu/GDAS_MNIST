...
def main(xargs):
    ...
    search_loader, _, valid_loader = get_nas_search_loaders(
        ...
        valid_data,
        xargs.dataset,
        r"C:\Users\xuke0\Desktop\GDAS_MNIST\configs\nas-benchmark",
        config.batch_size,
        xargs.workers,
    )
    logger.log(
...
if __name__ == "__main__":
    ...
    args.data_path = "data/cifar-10-python.tar.gz"
    ...
    args.config_path = r'C:\Users\xuke0\Desktop\GDAS_MNIST\configs\nas-benchmark\algos\GDAS.config'
    ...
    # args.arch_nas_dataset = '/home/xuke/Desktop/AutoDL-Projects/NAS-Bench-201-v1_1-096897.pth'
    args.print_freq = 200
    args.rand_seed = 42
